...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.listGradesFirst = wx.ListCtrl( self.PanelFirstYear, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_ICON|wx.LC_LIST )
		...
		self.listGradesFirst1 = wx.ListCtrl( self.PanelSecondYear, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_ICON|wx.LC_LIST )
		...
		self.listGradesFirst2 = wx.ListCtrl( self.PanelThirdYear, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_ICON|wx.LC_LIST )
		...
		self.listGradesFirst3 = wx.ListCtrl( self.PanelFourthYear, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_ICON|wx.LC_LIST )
